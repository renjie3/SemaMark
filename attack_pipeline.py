...
from utils.attack import (
    ...
    copy_paste_attack,
    scramble_attack,
    roundtrip_translation_attack,
    random_edit_attack,
    bart_paraphrase_attack,
)
...
def main(args):
    ...
    ###########################################################################
    # roundtrip tranlstion attack attack
    ###########################################################################

    elif args.attack_method == "translation":
        print("Running translation attack")
        gen_table_attacked_ds = roundtrip_translation_attack(
    ...
    elif args.attack_method == "random_edit":
        print("Running translation attack")
        gen_table_attacked_ds = random_edit_attack(
            gen_table_ds, args=args
        )
    ...
    elif args.attack_method == "bart":
        print("Running translation attack")
        gen_table_attacked_ds = bart_paraphrase_attack(
            gen_table_ds, args=args
        )
