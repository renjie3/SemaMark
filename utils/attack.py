...
from utils.roundtrip_translation import roundtrip_translation_paraphrases
from utils.random_edit_attack import random_edit
from utils.bart_paraphrase_attack import bart_paraphrase
...
SUPPORTED_ATTACK_METHODS = ["gpt", "dipper", "copy-paste", "scramble", "translation", "random_edit", "bart"]
...
def roundtrip_translation_attack(dataset, args=None):
    dataset = roundtrip_translation_paraphrases(dataset, args=args)
    return dataset

def random_edit_attack(dataset, args=None):
    dataset = random_edit(dataset, args=args)
    return dataset

def bart_paraphrase_attack(dataset, args=None):
    dataset = bart_paraphrase(dataset, args=args)
    return dataset
