...
def generate_dipper_paraphrases(
    ...
    time1 = time.time()
    tokenizer = T5Tokenizer.from_pretrained("google/t5-v1_1-xxl", cache_dir=args.hf_cache_dir)
    model = T5ForConditionalGeneration.from_pretrained(model_name, cache_dir=args.hf_cache_dir)
